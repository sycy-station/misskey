...
export default class extends Endpoint<typeof meta, typeof paramDef> { // eslint-disable-line import/no-default-export
	constructor(
		...
		super(meta, paramDef, async (ps, me) => {
			...
			this.emailService.sendEmail(ps.email, 'Password reset requested / 密码重置请求',
				`To reset password, please click this link / 要重置密码，请单击此链接:<br><a href="${link}">${link}</a>`,
				`To reset password, please click this link / 要重置密码，请单击此链接: ${link}`);
		});
	}
}
